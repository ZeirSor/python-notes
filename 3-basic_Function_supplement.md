...
- [7. 高阶函数](#7-高阶函数)
- [8. 闭包（Closure）](#8-闭包closure)
- [9. 装饰器](#9-装饰器)
  - [9.1. 被修饰的函数中有参数](#91-被修饰的函数中有参数)
  - [9.2. 带参数的装饰器](#92-带参数的装饰器)
    - [9.2.1. 让函数重复执行](#921-让函数重复执行)
    - [9.2.2. 测试代码1](#922-测试代码1)
    - [9.2.3. 测试代码2](#923-测试代码2)
  - [9.3. 伪应用场景](#93-伪应用场景)
    - [9.3.1. 登录认证](#931-登录认证)
    - [9.3.2. 面向对象](#932-面向对象)
    - [9.3.3. flask路由都是有参装饰器](#933-flask路由都是有参装饰器)
  - [9.4. 重要补充`functools`](#94-重要补充functools)
    - [9.4.1. **标准写法！**](#941-标准写法)
  - [9.5. 多个装饰器装饰一个函数](#95-多个装饰器装饰一个函数)
